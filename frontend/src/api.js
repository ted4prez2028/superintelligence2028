export const API = {
  ...
  async runReasoning(payload){ return post('/api/runners/reasoning', payload); },
  async runAutonomy(payload){ return post('/api/runners/autonomy', payload); },
  async getSystemState(){ const r = await fetch('/api/system/state'); return r.json(); },
